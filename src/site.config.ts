export const SITE = {
  name: 'Onur Cakmak',
  title: 'Onur Cakmak',
  description: 'Senior Software Engineer with 7+ years of Back-End experience. Passionate about quality products, deep technical learning, and collaborative team growth.',
